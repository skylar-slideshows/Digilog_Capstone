...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Disp_CS_0_Pin|Disp_CS_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_Data_Pin|LED_Clock_Pin|LED_Latch_Pin|FlashADC_CS_ADC_Pin
                          |FlashADC_CS_Flash_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Disp_CS_0_Pin Disp_CS_1_Pin */
  GPIO_InitStruct.Pin = Disp_CS_0_Pin|Disp_CS_1_Pin;

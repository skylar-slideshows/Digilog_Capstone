...
static void MX_OPAMP5_Init(void)
{
  ...
  hopamp5.Init.NonInvertingInput = OPAMP_NONINVERTINGINPUT_IO1;
...
static void MX_OPAMP6_Init(void)
{
  ...
  hopamp6.Init.NonInvertingInput = OPAMP_NONINVERTINGINPUT_IO1;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, DISP_RST_Pin|DISP_CS1_Pin|DISP_CS2_Pin|DAC_LDAC1_Pin
                          |DAC_LDAC0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DISP_CS0_Pin|LED_Data_Pin|LED_Clock_Pin|LED_Latch_Pin
                          |DISP_CS3_Pin|DAC_LDAC2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, DAC_LDAC4_Pin|DAC_LDAC3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DISP_RST_Pin DISP_CS1_Pin DISP_CS2_Pin DAC_LDAC1_Pin
                           DAC_LDAC0_Pin */
  GPIO_InitStruct.Pin = DISP_RST_Pin|DISP_CS1_Pin|DISP_CS2_Pin|DAC_LDAC1_Pin
                          |DAC_LDAC0_Pin;
  ...
  /*Configure GPIO pins : MASTER_CS_IN_Pin F3_Touch_Pin F2_Touch_Pin F1_Touch_Pin */
  GPIO_InitStruct.Pin = MASTER_CS_IN_Pin|F3_Touch_Pin|F2_Touch_Pin|F1_Touch_Pin;
  ...
  /*Configure GPIO pins : DISP_CS0_Pin LED_Data_Pin LED_Clock_Pin LED_Latch_Pin
                           DISP_CS3_Pin DAC_LDAC2_Pin */
  GPIO_InitStruct.Pin = DISP_CS0_Pin|LED_Data_Pin|LED_Clock_Pin|LED_Latch_Pin
                          |DISP_CS3_Pin|DAC_LDAC2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : DAC_LDAC4_Pin DAC_LDAC3_Pin */
  GPIO_InitStruct.Pin = DAC_LDAC4_Pin|DAC_LDAC3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;

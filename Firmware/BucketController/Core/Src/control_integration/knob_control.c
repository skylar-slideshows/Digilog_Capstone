/**
  ...
  **********************************************************************************
  * @file knob_control.c
  * @brief Accumulates rotary encoder motion into a channel's control scalars, and scales those
  *        scalars back down onto the 32-LED knob rings.
  *
  ...
  *          accepted and ignored. The ring scaling is off by one - see the Architecture
  *          page, section 6.
  *

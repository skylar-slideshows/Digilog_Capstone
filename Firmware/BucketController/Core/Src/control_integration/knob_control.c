/**
  **********************************************************************************
  * KNOB CONTROL - DIGILOG CONSOLE
  **********************************************************************************
  * @file knob_control.c
  * @brief Accumulates rotary encoder motion into a channel's control scalars, and hands
  *        those scalars to the LED driver for display. Takes the channel mutex around
  *        every read or write of the control values.
  *
  * @warning Partially wired. init_knob_controls() populates two knobs with hardcoded
  *          I2C1 / channel 0 values and dummy button info; the channel argument is
  *          accepted and ignored.
  *
  * @note Scaling no longer happens here. The old sscalar_to_8bit() / uscalar_to_8bit()
  *       helpers were removed; led_set() and led_set_signed() take the full-range scalar
  *       and led_render() derives ring positions from each device's own geometry.
  *

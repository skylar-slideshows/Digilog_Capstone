/**
  ...
  * @brief Edge-detects push buttons and toggles the corresponding console values, under
  *        the channel mutex. Also runs the press_countdown timer that lets a second press
  *        inside DOUBLE_PRESS_TIME register as a double click.
  *

/**
  **********************************************************************************
  * KNOB CONTROL - PRIVATE HEADER - DIGILOG CONSOLE
  **********************************************************************************
  * @file knob_control.h
  * @brief Internal to control_integration. Not on the public include path.
  *
  * @note The include guard still reads ROTARY_ENCODER_CONTROL_H, from before this file
  *       was renamed from rotary_encoder_control.h.
  *

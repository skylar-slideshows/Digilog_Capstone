/**
  **********************************************************************************
  * CONTROL INTERFACE - DIGILOG CONSOLE
  **********************************************************************************
  * @file control_interface.c
  * @brief Owns the per-channel control state and drives the update cycle: init_control_interface()
  *        at startup, then update_control_values() and update_control_leds() from the main loop.
  *        Dispatches to the knob, button and fader modules for each of CHANNELS channels.
  *

/**
  ...
  *
  * @warning Incomplete. fader_info_t now carries real touch-sensor, motor and ADC
  *          fields, but the driver's hardware primitives that would use them are
  *          still unimplemented - see fader_driver.c.
  *

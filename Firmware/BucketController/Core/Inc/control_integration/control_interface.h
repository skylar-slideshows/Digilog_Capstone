/**
  **********************************************************************************
  * CONTROL INTERFACE - PUBLIC HEADER - DIGILOG CONSOLE
  **********************************************************************************
  * @file control_interface.h
  * @brief The one public type of the control_integration layer: what the console *means*,
  *        expressed in device-independent normalized scalars rather than volts, dB or DAC
  *        counts. The CV engine, remote command handler and state-save code all consume
  *        this; none of them should know an I2C address. See the Architecture page,
  *        section 5, for why the physical-location and raw-reading trees are kept private.
  *
  *        Also declares channel_control_mutexes[], one FreeRTOS mutex per channel. The
  *        caches below the control layer are not thread-safe; these are what make
  *        concurrent access to the control values safe.
  *

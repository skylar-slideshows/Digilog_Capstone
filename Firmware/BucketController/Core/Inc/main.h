...
#define Fader2_ADC_Pos_Pin GPIO_PIN_0
#define Fader2_ADC_Pos_GPIO_Port GPIOC
#define LED_PWM_Pin GPIO_PIN_1
#define LED_PWM_GPIO_Port GPIOC
#define Fader3_ADC_Pos_Pin GPIO_PIN_2
#define Fader3_ADC_Pos_GPIO_Port GPIOC
#define Fader4_ADC_Pos_Pin GPIO_PIN_3
#define Fader4_ADC_Pos_GPIO_Port GPIOC

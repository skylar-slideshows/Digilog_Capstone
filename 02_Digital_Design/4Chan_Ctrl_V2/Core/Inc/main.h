...
/* Private defines -----------------------------------------------------------*/
#define Disp_CS_0_Pin GPIO_PIN_13
#define Disp_CS_0_GPIO_Port GPIOC
...
#define Disp_CS_1_GPIO_Port GPIOC
...
#define CV2_Clock_Pin GPIO_PIN_6
#define CV2_Clock_GPIO_Port GPIOC
#define CV2_Data_Pin GPIO_PIN_7
#define CV2_Data_GPIO_Port GPIOC
#define CV1_Clock_Pin GPIO_PIN_8
#define CV1_Clock_GPIO_Port GPIOC
#define Fader4_MotB_Pin GPIO_PIN_9
#define Fader4_MotB_GPIO_Port GPIOC
#define Ctrl2XCV_Data_Pin GPIO_PIN_8
#define Ctrl2XCV_Data_GPIO_Port GPIOA
#define Ctrl2XCV_Clock_Pin GPIO_PIN_9
#define Ctrl2XCV_Clock_GPIO_Port GPIOA
#define Fader2_MotB_Pin GPIO_PIN_10
#define Fader2_MotB_GPIO_Port GPIOA
#define Ctrl1_Clock_Pin GPIO_PIN_13
#define Ctrl1_Clock_GPIO_Port GPIOA
#define Ctrl1_Data_Pin GPIO_PIN_14
#define Ctrl1_Data_GPIO_Port GPIOA
...
#define CV1_Data_Pin GPIO_PIN_5
#define CV1_Data_GPIO_Port GPIOB
